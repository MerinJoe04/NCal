...
public class SubActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et1=(EditText) findViewById(R.id.noo4);
        et2=(EditText) findViewById(R.id.noo3);
        et3=(TextView) findViewById(R.id.ttid);

        b5=(Button)  findViewById(R.id.subm);
        b55=(Button)  findViewById(R.id.subn);
